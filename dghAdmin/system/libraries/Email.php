...
class CI_Email {
	...
	var	$smtp_host		= "mail.dghindia.org";		// SMTP Server.  Example: mail.earthlink.net
    	//var	$smtp_host		= "mail.vasinfosolution.co.in";	
	//var	$smtp_user		= "dgh@vasinfosolution.co.in";		// SMTP Username
	var	$smtp_user		= "dghweb@dghindia.org";		// SMTP Username
	var	$smtp_pass		= "@Dg12345";		// SMTP Password
	var	$smtp_port		= "25";		// SMTP Port
	var	$smtp_timeout	= 25;		// SMTP Timeout in seconds
