...
<div class="Wrapper">
    ...
    <div class="ContentWrapper">
        ...
        <div class="formWrapper smallWrapper" id="addNewForm">
            ...
            <form action="<?php echo $this->config->base_url(); ?>index.php/admin/categories" method="POST" enctype="multipart/form-data" id="groupForm">     
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="userTable">
                    ...
                    <tbody>
                        ...
                        foreach ($category as $GI) {
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo strip_tags($GI['category']); ?></td>
                                <td class="actionRow">
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/admin/categories?editRowId=<?php echo $GI['id']; ?>" ><button type="button" name="" value="" class="Editbtn"  title="Edit"></button></a>
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/admin/categories?deleteId=<?php echo $GI['id']; ?>" ><button type="button" name="" value="" class="DeleteIcon"  title="Delete"></button></a>
                                </td>
                            </tr>
                            <?php
                            $i++;
