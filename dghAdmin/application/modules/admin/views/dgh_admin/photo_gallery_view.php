        ...
        <div class="formWrapper smallWrapper" id="addNewForm">
            <div class="HeadingTop">
                ...
                <div class="SearchTable">
                    <a href="<?php echo $this->config->base_url(); ?>index.php/photo/categories"><button id="addNewFormToggle" style="font-size: 20px;">×</button></a>
                </div>
            </div>
            
            <form action="<?php echo $this->config->base_url(); ?>index.php/photo/categories" method="POST" enctype="multipart/form-data" id="groupForm">     

                <div class="clearfix">
                    <div class="one-third">
                        <label>Category Name:</label>

                        <input type="text" name="category" value="<?php echo $editDetails['category']; ?>" />
    ...
    ?>
                <table cellpadding="0" cellspacing="0" border="0" id="userTable">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        foreach ($category as $GI) {
                            
                            ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $GI['category']; ?></td>
                                <td class="actionRow">
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/photo/categories?editRowId=<?php echo $GI['id']; ?>" ><button type="button" name="" value="" class="Editbtn"  title="Edit"></button></a>
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/photo/categories?deleteId=<?php echo $GI['id']; ?>" ><button type="button" name="" value="" class="DeleteIcon"  title="Delete"></button></a>
                                </td>
                            </tr>
                            <?php
                            $i++;
