        ...
        <div class="formWrapper smallWrapper" id="addNewForm">
            <div class="HeadingTop">
                ...
                <div class="SearchTable">
                    <a href="<?php echo $this->config->base_url(); ?>index.php/admin/stories"><button id="addNewFormToggle" style="font-size: 20px;">×</button></a>
                </div>
            </div>
            
            <form action="<?php echo $this->config->base_url(); ?>index.php/admin/stories" method="POST" enctype="multipart/form-data" id="groupForm">     
                ...
                <div class="clearfix">
                    <div class="one-third">
                        ...
                        <select name="type">
                            ...
                            <option value="1" <?php if($editDetails['type']=='1'){ ?>selected="selected"<?php } ?>>Story</option>
                            <option value="2" <?php if($editDetails['type']=='2'){ ?>selected="selected"<?php } ?>>News</option>
                        </select>
                        <label>Title:</label>

                        <input type="text" name="title" value="<?php echo $editDetails['title']; ?>" />
                        
                        <label>Description:</label>
                        <textarea id="description" name="description"><?php echo $editDetails['description']; ?></textarea>
                        <script>
                    ...
                    <tbody>
                        ...
                        foreach ($story as $GI) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $GI['description']; ?></td>
                                <td class="actionRow">
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/admin/stories?editRowId=<?php echo $GI['id']; ?>" ><button type="button" name="" value="" class="Editbtn"  title="Edit"></button></a>
                                    <a  href="<?php echo $this->config->base_url(); ?>index.php/admin/stories?deleteId=<?php echo $GI['id']; ?>" onclick="return confirm('Are you sure');" ><button type="button" name="" value="" class="DeleteIcon"  title="Delete"></button></a>
                                </td>
                            </tr>
                            <?php
                            $i++;
