                ...
                <div class="clearfix">
                    <div class="one-third">
                        ...
                        <select name="category">
                            ...
                            <option value="<?php echo $cat['id'] ?>" <?php if($cat['id']==$editDetails['category']){ ?>selected="selected"<?php }?>><?php echo $cat['category'] ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="one-third">
                        <label>Page Name Hindi:</label>

                        <input type="text" name="pageNameHindi" value="<?php echo $editDetails['page_hindi']; ?>" />
...
if (count($staticPage) > 0) {
    ?>
            <table cellpadding="0" cellspacing="0" border="0" id="userTable" style="display:block !important">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Page Name</th>
                    ...
                    <tbody>
                        ...
                        foreach ($staticPage as $GI) {
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo substr(strip_tags($GI['page'],0,100)); ?></td>
                                <td class=""><?php echo substr(strip_tags($GI['content']),0,100)."..."; ?></td>
                                <td class="actionRow">
